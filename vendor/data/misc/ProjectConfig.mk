...
#end by lrz 
#BSP: modify XWWYWPO-3197 by ka.fang 20180926 start
CUSTOM_CONFIG_MAX_DRAM_SIZE = 0x800000000
#BSP: modify XWWYWPO-3197 by ka.fang 20180926 end
CUSTOM_HAL_ANT = mt6739_ant_m1
CUSTOM_HAL_AUDIOFLINGER = audio
CUSTOM_HAL_BLUETOOTH = bluetooth
CUSTOM_HAL_CAMERA = camera
#ITD:modify for XWWYWHSJB-13 by tianpeng.zhang 20180802 start
CUSTOM_HAL_CAM_CAL = s5k3l8_eeprom s5k3l6_eeprom
CUSTOM_HAL_COMBO = mt6739
CUSTOM_HAL_EEPROM = dummy_eeprom
CUSTOM_HAL_FLASHLIGHT = constant_flashlight
CUSTOM_HAL_IMGSENSOR = s5k3l8_mipi_raw s5k3l6_mipi_raw gc8034_mipi_raw
...
#ITD:modify for XWWYWHSJB-13 by tianpeng.zhang 20180802 end
...
#ITD:modify for XWWYWHSJB-13 by tianpeng.zhang 20180802 start
CUSTOM_KERNEL_CAM_CAL = s5k3l8_eeprom s5k3l6_eeprom
#ITD:modify for XWWYWHSJB-13 by tianpeng.zhang 20180802 end
...
#ITD:modify for XWWYWHSJB-13 by tianpeng.zhang 20180802 start
CUSTOM_KERNEL_IMGSENSOR = s5k3l8_mipi_raw s5k3l6_mipi_raw gc8034_mipi_raw
CUSTOM_KERNEL_IN_POCKET_SENSOR = no
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LEDS = mt65xx
CUSTOM_KERNEL_LENS = dw9718saf dummy_lens
#ITD:modify for XWWYWHSJB-13 by tianpeng.zhang 20180802 end
#modify XWWYWHSJB-6 by wurui.zhang 2018-03-08 start
CUSTOM_KERNEL_MAGNETOMETER = no
#modify XWWYWHSJB-6 by wurui.zhang 2018-03-08 end
...
#SID:add lijia.chen XWWYWPO-5346 20181015 start
LOVELYFONTS_SUPPORT = no
#SID:add lijia.chen XWWYWPO-5346 20181015 end
MAXIM_SPEAKER_SUPPORT = no
MCUPM_FW_USE_PARTITION = yes
MD32_TOOLCHAIN_MODULE = IPDesigner/12R2.36-64
MD5_SIZE = 0x01600000
MD5_SMEM_SIZE = 0x00200000
#BSP:modify XWWYWPO-505 by yong.jiang 2018.8.3 start
MICROTRUST_TEE_SUPPORT = yes
#BSP:modify XWWYWPO-505 by yong.jiang 2018.8.3 end
MNTL_SUPPORT = no
...
#SID:add XWWYWPO-1 lijia.chen start
MTK_BUILD_VERNO=X5515F-H398F-P-200715V425
FINGERPRINT_BUILD_VERNO=F-200715V425
#SID:add XWWYWPO-1 lijia.chen end
MTK_BWC_SUPPORT = yes
MTK_C2K_LTE_MODE = 0
...
#ITD:modify tun off EIS by tianpeng.zhang 20181011 start
MTK_CAM_EIS_SUPPORT = no
#ITD:modify tun off EIS by tianpeng.zhang 20181011 end
MTK_CAM_FACEBEAUTY_SUPPORT = no
MTK_CAM_FD_SUPPORT = yes
MTK_CAM_HDR_DETECTION_MODE = 0
#ITD:modify for use our hdr by gao.xu 20181017 start
MTK_CAM_HDR_SUPPORT = no
#ITD:modify for use our hdr by gao.xu 20181017 end
...
# Modify by zhaoyang.shi for storage default path enhancement start
MTK_DEFAULT_WRITE_DISK = no
# Modify by zhaoyang.shi for storage default path enhancement end
...
#BSP:modify XWWYWPO-75 by peixuan.qiu 20180726 start
MTK_FACTORY_MODE_IN_GB2312 = no
#BSP:modify XWWYWPO-75 by peixuan.qiu 20180726 end
...
MTK_FIRST_MD = 1
#TSD：modify XWWYWHSJB-1914 by renyanzhen 20180629 start
MTK_FLIGHT_MODE_POWER_OFF_MD = yes
#TSD：modify XWWYWHSJB-1914 by renyanzhen 20180629 end
...
MTK_IRTX_SUPPORT = no
#modify XWWYWHSJB-535 by xiaoyu.wang 20180408 start
MTK_JEITA_STANDARD_SUPPORT = yes
TRAN_CHARGER_COULOMB_SUPPORT = yes
#modify XWWYWHSJB-535 by xiaoyu.wang 20180408 end
...
#SID:add XWWYWPO-1 by lijia.chen start
MTK_PERMISSION_CONTROL = no
#SID:add XWWYWPO-1 by lijia.chen end
...
#SID:add XWWYWPO-35 lijia.chen start
...
#TDD: modify XWWYWPO-1220 by bo.zhou 20180808 start
MTK_WMA_PLAYBACK_SUPPORT = no
#TDD: modify XWWYWPO-1220 by bo.zhou 20180808 end
...
#add XWWYWHSJB-1 by wangruizhe 20180305 start
CUSTOM_TRAN_PROJECT= tran_x5515
CUSTOM_TRAN_BOM= tran_x5515_f
#BSP:modify XWWYWHSJB-2068 by yong.jiang 20180726 start
TRAN_FINGERPRINT_SUPPORT = no
#BSP:modify XWWYWHSJB-2068 by yong.jiang 20180726 end
#add XWWYSHSJW-2024 by yangyong 20180408 secboot start
TRAN_SEC_FILE_COPY_SUPPORT=yes
#add XWWYSHSJW-2024 by yangyong 20180408 secboot end

#add XWWYWHSJB-6 by wurui.zhang 2018-05-31 start
TRAN_GSENSOR_MXC4005XC_SUPPORT=yes
#add XWWYWHSJB-6 by wurui.zhang 2018-05-31 end

# BSP:add XWWYWPO-846 by baofu.zhang 20180801 start
TRAN_LCM_SUPPORT = yes
# BSP:add XWWYWPO-846 by baofu.zhang 20180801 end

#add by zhengbo.tang, OSPDEV-531, 20180703 start
TRAN_TP_SUPPORT = yes
#add by zhengbo.tang, OSPDEV-531, 20180703 end

#add XWWYWPO-4 by haiping.bai 20180704 start
TRAN_AUDIOTEST_SUPPORT = yes
#add XWWYWPO-4 by haiping.bai 20180704 end

#TDD: add XWWYWPO-31 by wenqiang.zhang 20180716 start
TRAN_GMS_O_UPDATE_APPROVE = yes
#TDD: add XWWYWPO-31 by wenqiang.zhang 20180716 end

#PPD: add XWWYWPO-63 by peng.zhang 20180720 start
TRAN_VM_STARTSIZE = 8m
TRAN_VM_MAXFREE_SIZE = 8m
TRAN_VM_MINFREE_SIZE = 2m
#PPD: add XWWYWPO-63 by peng.zhang 20180720 end

#PPD: add XWWYWPO-5716 by liang.chen5 20181022 start
TRAN_SKIP_VP9_FOR_YOUTUBE = yes
#PPD: add XWWYWPO-5716 by liang.chen5 20181022 end
...
# Add XWWYWPO-52 by peixuan.qiu for customizing meta function 20180717 start
TRAN_FT_RESET = yes
TRAN_FT_REBOOT = yes
TRAN_FT_CUSTOM_SHELL = yes
TRAN_FT_SIM_SD_TRAY_DETECT = yes
TRAN_FT_BENCHFLAG_SUPPORT = yes
# Add XWWYWPO-52 by peixuan.qiu for customizing meta function 20180717 end
#add CFQHLYE-14 by hong.zhang for porting f2fs 201800720 start
TRAN_USE_F2FS = yes
#add CFQHLYE-14 by hong.zhang for porting f2fs 20180720 end

#BSP:add XWWYWPO-147 by peixuan.qiu 20180802 start 
TRAN_SYSTEM_DEVINFO=yes
#BSP:add XWWYWPO-147 by peixuan.qiu 20180802 end 
#ITD modify for thirdpart apk by wei.miao@transsion.com 20180930 start
TRAN_CAMERA_THIRDPART = yes
#ITD modify for thirdpart apk by wei.miao@transsion.com 20180930 end
#[ITD]add cam 3pty function XWWYWHSJB-2039 by yubao.zeng start
TRAN_CAMERA_FEATURE = yes
#[ITD]add cam 3pty function XWWYWHSJB-2039 by yubao.zeng end
#SID:add XWWYWPO-1769 by zhangtao 20180911 start
TRAN_DEFAULT_PHOTO_SUPPORT = yes
#SID:add XWWYWPO-1769 by zhangtao 20180911 end

#BSP:add XWWYWPO-3808 by yongqing.dou 20180914 start
TRAN_CAM_NOTIFY_SUPPORT = yes
#BSP:add XWWYWPO-3808 by yongqing.dou 20180914 end
